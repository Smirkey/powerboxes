...
use numpy::{IntoPyArray, PyArray, PyArray1, PyArray2, PyArray3, PyArrayMethods};
use pyo3::prelude::*;
...
pub fn preprocess_boxes<'py, N>(
    array: &'py Bound<'py, PyArray2<N>>,
) -> Result<ArrayBase<ViewRepr<&'py N>, Dim<[usize; 2]>>, PyErr>
where
    N: numpy::Element,
{
